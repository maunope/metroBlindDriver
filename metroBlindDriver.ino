...
void loop() {
  ...
  */
  ...
  if (digitalRead(RUNNING_PIN) == LOW && (millis() / 1000 > 30) && ((millis() - lastCommandReceived) / 1000) > 30) {
    ...
    //Flush serial, or the interrupts generated by any otuput still to be done will cancel idle
    Serial.flush();
    LowPower.idle(SLEEP_4S, ADC_OFF, TIMER4_OFF, TIMER3_OFF, TIMER1_OFF, TIMER0_ON, SPI_OFF, USART1_OFF, TWI_OFF, USB_OFF);
